  ...
  .controller('MainCtrl', function ($scope, $location, $modal, snippetFactory, apiFactory) {
    ...
    if($scope.documents){
     ...
     $scope.test = function(){
      ...
      //  console.log(data)
      //})
      snippetFactory.getSnippet('-M50', 2).then(function(data){
        console.log(data)
      })
